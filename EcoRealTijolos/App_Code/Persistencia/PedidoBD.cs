...
namespace EcoRealTijolos.App_Code.Persistencia
{
    ...
    public class PedidoBD
    {
        ...
        public bool Insert(Pedido pedido)
        {
            ...
            string sql = "INSERT INTO tbl_pedido (ped_data, ped_endereco, ped_obs) VALUES (?data, ?enderecoEntrega, ?observacao)";
            objConexao = Mapped.Connection();
            objCommand = Mapped.Command(sql, objConexao);
            objCommand.Parameters.Add(Mapped.Parameter("?data", pedido.Data));
            objCommand.Parameters.Add(Mapped.Parameter("?endereco", pedido.EnderecoEntrega));
