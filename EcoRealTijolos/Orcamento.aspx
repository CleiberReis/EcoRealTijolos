                ...
                <div class="box box-primary">
                    <div class="box-body">
                        <div id="print" class="orcamento">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <asp:Button ID="btnOrcamento" runat="server" CssClass="btn btn-primary" Text="Calcular Valor Final" OnClick="btnOrcamento_Click" />
                                </div>
                                <div class="col-md-6">
                                    <button class="btn btn-github" onclick="window.print()">Imprimir Orçamento</button>
                                </div>
                            </div>
                        </div>
                    </div>
